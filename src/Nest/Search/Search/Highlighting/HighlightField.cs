...
namespace Nest
{
	...
	public class HighlightField : IHighlightField
	{
		...
		{
			get { return this.TypeHack.ToEnum<HighlighterType>(); }
			set { this.TypeHack = value.GetStringValue(); }
		}
		public string TypeHack { get; set; }
...
#pragma warning disable CS0618 // Type or member is obsolete
			get { return Self.TypeHack.ToEnum<HighlighterType>(); }
			set { Self.TypeHack = value.GetStringValue(); }
#pragma warning restore CS0618 // Type or member is obsolete
		}
		string IHighlightField.TypeHack { get; set; }
...
#pragma warning disable CS0618 // Type or member is obsolete
		public HighlightFieldDescriptor<T> Type(string type) => Assign(a => a.TypeHack = type);
#pragma warning restore CS0618 // Type or member is obsolete
